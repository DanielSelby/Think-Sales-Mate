    ...
    <div className="space-y-4">
      <div className="grid grid-cols-3 gap-3">
        <div className="rounded-xl bg-signal-soft p-3">
          ...
          <p className="figure mt-1 text-sm font-semibold text-ink-900 dark:text-ink-900">{formatMoney(cashIn, currency)}</p>
        </div>
        <div className="rounded-xl bg-alert-soft p-3">
          ...
          <p className="figure mt-1 text-sm font-semibold text-ink-900 dark:text-ink-900">{formatMoney(cashOut, currency)}</p>
        </div>
        <div className="rounded-xl bg-ledger-50 p-3 dark:bg-ink-950">
          ...
          <p className={`figure mt-1 text-sm font-semibold ${netCashFlow >= 0 ? "text-signal" : "text-alert"}`}>
