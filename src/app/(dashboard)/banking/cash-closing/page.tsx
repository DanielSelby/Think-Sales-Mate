    ...
    <div className="min-h-full bg-[#f4f8fc] px-4 py-5 dark:bg-ink-950 md:px-6">
      <div className="mx-auto max-w-[1440px] space-y-5">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="flex gap-2"><BranchSelector selectedLocationId={selectedLocationId} locations={scopedLocations(locations)} isBranchScoped={ctx.isBranchScoped} /><label className="flex h-10 items-center gap-2 rounded-lg border border-[#d5e2ef] bg-white px-3 text-xs font-medium text-[#31577c] shadow-sm dark:border-ledger-700 dark:bg-ink-900"><CalendarDays className="h-4 w-4 text-[#2087e5]" />{new Date(today).toLocaleDateString(undefined, { day: "2-digit", month: "short", year: "numeric" })}<ChevronDown className="h-3 w-3" /></label></div>
        </div>
