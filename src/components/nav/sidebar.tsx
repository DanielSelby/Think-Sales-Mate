...
const LEGACY_NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    href: "/inventory/adjustments?mode=adjustment",
    icon: ClipboardEdit,
    status: "live",
    children: [
...
export function Sidebar({ collapsed, enabledModules, systemLogoUrl }: { collapsed: boolean; enabledModules?: string[]; systemLogoUrl?: string | null }) {
  const pathname  = usePathname();
